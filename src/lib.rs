// src/lib.rs
/*
 * Core library for TextSummarization
 */
...
#[derive(Debug)]
pub struct TextSummarizationProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TextSummarizationProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TextSummarization processing");
    
    let mut processor = TextSummarizationProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TextSummarizationProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TextSummarizationProcessor::new(false);
